...
/*   if (mittel == Transportmittel.auto) {
  ...
  print("1. Max: ${reiseroute["Max"]} km, Zeit: ${zeitMax.toStringAsFixed(2)} Stunden");
  print(
  ...
  print("Durchschnittliche Entfernung pro Freund: ${durchschnittsKm.toStringAsFixed(2)} km");
  print("Durchschnittliche Fahrzeit pro Freund: ${durchschnittsZeit.toStringAsFixed(2)} Stunden");
